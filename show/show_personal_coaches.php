...
print('<body>');
include "./middle.php";
$query = "CALL GetPersonalCoaches_OnePerson('" .$_SESSION['selected_athlete']. "') ";
$result = $mysqli->query($query)
or die(mysqli_error($mysqli));
print "<p class='show_title'>Personal Coaches</p>";
...
action = './edit_personal_coach.php'>";
...
value = './show_personal_coaches.php' />";
		print "</form>";
		print "<form class='buttons_form' method = 'post'
action = './delete_personal_coach.php'>";
...
value = './show_personal_coaches.php' />";
	...
	for ($i=0; $i<$numfields; $i++) {
		...
		} elseif ($i==$coach_column && $row[$i]!="") {
			$rand_val = rand();
			$url="show_coach.php?coach=$row[$i]&sid=$rand_val";
			print "<td class='datafields_td'><a href='$url'>$row[$i]</a></td>";
		} else {
