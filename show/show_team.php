...
$query = "CALL GetTeamInfo('$team')";
$result = $mysqli->query($query)
or die(mysqli_error($mysqli));
print "<p class='show_title'>Team</p>";
...
action = './edit_team.php'>";
		print "<input type = submit name = 'submit_edit' value = 'edit' />";
		print "<input type = 'hidden' name = 'team' value = '".$row['Team']."' />";
		print "<input type = 'hidden' name = 'url'
value = './show_team.php?team={$team}' />";
		print "</form>";
		print "<form class='buttons_form' method = 'post'
action = './delete_team.php'>";
