...
print('<body>');
include "./middle.php";
$query = "CALL GetExercises_OneAthlete('" .$_SESSION['selected_athlete']. "')";
$result = $mysqli->query($query)
or die(mysqli_error($mysqli));
print "<p class='show_title'>Exercises</p>";
...
action = './edit_exercise.php'>";
		print "<input type = submit name = 'submit_edit' value = 'edit' />";
		print "<input type = 'hidden' name = 'person'
value = '".$row['Person']."' />";
		print "<input type = 'hidden' name = 'date'
value = '".$row['Exercise Date']."' />";
		print "<input type = 'hidden' name = 'time'
value = '".$row['Exercise Time']."' />";
		print "<input type = 'hidden' name = 'url'
value = './show_exercises.php' />";
		print "</form>";
		print "<form class='buttons_form' method = 'post'
action = './delete_exercise.php'>";
