...
print('<body>');
include "./middle.php";
$query = "CALL GetAllEquipmentInfo()";
$result = $mysqli->query($query)
or die(mysqli_error($mysqli));
print "<p class='show_title'>Equipment</p>";
...
action = './edit_equipment.php'>";
		print "<input type = submit name = 'submit_edit' value = 'edit' />";
		print "<input type = 'hidden' name = 'brand' value = '".$row['Brand']."' />";
		print "<input type = 'hidden' name = 'model' value = '".$row['Model']."' />";
		print "<input type = 'hidden' name = 'sport' value = '".$row['Sport']."' />";
		print "<input type = 'hidden' name = 'url'
value = './show_equipment.php' />";
		print "</form>";
		print "<form class='buttons_form' method = 'post'
action = './delete_equipment.php'>";
