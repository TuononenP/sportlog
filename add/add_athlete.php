...
print('<body onload="document.add_athlete.person.focus()">');
include "./middle.php";
...
<form name="add_athelete" id="add_athlete"
	...
	<fieldset>
		<label for="person"> Person: <input type="text" name="person"
			...
			Weight: <input type="text" name="weigth" id="weight"
...
<form name="add_athlete" id="add_athlete"
	action="<?php echo $_SERVER['$PHP_SELF']; ?>" method="post"
	onreset="formReset(this); return false;">
	<fieldset>
		<label for="person"> Person: <input type="text" name="person"
			id="person" style="width: 250px" /> * </label> <label for="weight">
			Weight: <input type="text" name="weight" id="weight" /> </label> <label
			for="height"> Height: <input type="text" name="height" id="height" />
		</label> <label for="birthdate"> Birthdate: <select name="month"
			id="month">
				<option value="">
					month
				</option>
			...
			type="text" name="rest_hr" id="rest_hr" /> </label> <label
			for="max_hr"> Max heartrate: <input type="text" name="max_hr"
			id="max_hr" /> </label> <label for="blood_pres_sys"> Blood pressure
			systolic: <input type="text" name="blood_pres_sys"
			id="blood_pres_sys" /> </label> <label for="blood_pres_dias"> Blood
			pressure diastolic: <input type="text" name="blood_pres_dias"
			id="blood_pres_dias" /> </label> <label for="team"> Team: <select
			name="team" id="team">
				<option value="">
					-------
				</option>
