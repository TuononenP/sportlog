...
print('<body>');
include "./middle.php";
$query = "CALL GetOnePersonInfo('" . $_SESSION['selected_athlete'] . "') ";
$result = $mysqli->query($query)
or die(mysqli_error($mysqli));
print "<p class='show_title'>Athlete</p>";
...
value = './show_selected_athlete.php' />";
		print "</form>";
		print "<form class='buttons_form' method = 'post'
action = './delete_athlete.php'>";
